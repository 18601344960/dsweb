 ...
 */
@Entity
@Table(name = "OBT_CONFERENCE_STEP")
public class ConferenceStep extends ObjectBase {

    public ConferenceStep() {
        super();
        objectType = ObjectType.OBT_CONFERENCE_STEP;
    }
