...
public final class RequestUtils {
     ...
     * @return
     */
    public static String getLoginNo(HttpServletRequest request) {
        return getCookieValue(request, BaseConstants.REQ_CUR_USER_LOGIN_NO);
    }

    /**
     * <B>方法名称：</B>获取Cookie登录密码<BR>
     * <B>概要说明：</B><BR>
     * 
     * @author 易文俊
     * @since 2016年9月27日
    ...
    public static String getLoginPassword(HttpServletRequest request) {
        return getCookieValue(request, BaseConstants.REQ_CUR_USER_LOGIN_PASSWORD);
    }
    ...
    public static String getParameter(HttpServletRequest request, String parameter) {
        ...
        if (param == null || param.toLowerCase().contains("<script>") || param.toLowerCase().contains("?")) {
            return "";
        } else {
            return param;
        }
